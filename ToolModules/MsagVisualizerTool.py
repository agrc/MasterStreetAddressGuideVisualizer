...
@author: kwalker
'''
import arcpy, os, csv, imp, fields, configs, re, ScriptRunTime, AddressTableParser
import copy
...
class MsagVisualizerTool(object):
    ...
    def _createOuputRow(self, zip4Num, type, address):#I don't know what "type" is yet
        ...
        outRow = [zip4Num, 
                ...
                "{} {}".format(address.houseNumber, address.streetName), 
                address.zone, 
        ...
        for addrGroup in addrGroups:
            ...
            for addr in addrGroup.getAddresses():
                ...
                if not addr.isFound:
                    ...
                    addrProblemCursor.insertRow(self._createOuputRow(addrGroup.groupNumber, "T", addr))
                else:
            ...
            if len(foundAddrList) == 0:
                noMatchList.append(self._createOuputRow(addrGroup.groupNumber, "T", addrGroup.getAddresses()[0]))
                #print "noMatchTable"
            ...
            #Create a point result    
                ...
                insertRow = self._createOuputRow(addrGroup.groupNumber, "T", foundAddrList[0])
            ...
            #Create a line result    
                ...
                insertRow = self._createOuputLineRow(addrGroup.groupNumber, "T", foundAddrList)
                insertRow.append(line)
                lineList.append(insertRow)
                #Temp loop to show which addresses make up a line
#                 for addr in foundAddrList:
#                     insertRow = self._createOuputRow(addrGroup.groupNumber, "T", addr)#foundAddrList[0])
#                     insertRow.append(line)
#                     lineList.append(insertRow)
